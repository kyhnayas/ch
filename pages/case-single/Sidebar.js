    ...
    return (
            ...
            <div className="pl-[40px] lg:pl-0 md:mt-[40px]">
                <form>
                    <div className="relative">
                        <input type="text" className="form-control w-full text-[16px] border border-[#ddd] h-[50px]  pl-[10px] focus:outline-0 focus:shadow-none  text-[#D8D8D8]" placeholder="Karar Ara..." />
                        <button type="submit" className="text-[20px] text-white  bg-[#ffffff] absolute right-0 top-[52%] h-[50px]
      ...
      before:border-t-[13px] before:border-t-[rgba(0,0,0,.1)]
       before:top-full before:left-[30px] ">
                        <h3 className="text-[24px] text-[#ffffff]">Kategoriler</h3>
                    </div>
                    <div className="pt-[15px] px-[30px] pb-[20px]">
                        <ul>
                            {Practices.map((practice, Pitem) => (
                                <li className="border-b border-[#ddd]" key={Pitem}><Link onClick={ClickHandler} href='/practice-single/[slug]' as={`/practice-single/${practice.slug}`} className="text-[15px] pt-[15px] pb-[10px] text-[#333] block transition-all ease-in-out hover:text-[#e5e7eb]">{practice.sTitle}</Link></li>
                            ))}
                        </ul>
                    </div>
                </div>
                <div className="mt-[65px] pt-[15px] px-[30px] pb-[20px] bg-[#f5f5f5]">
                    <h3 className="text-[25px] relative text-[#ffffff] text-left capitalize pb-[20px] font-medium
        ">Son Kararlar</h3>
                    <div className="mt-[10px]">
                     ...
                     text-[#666] transition-all hover:text-[#e5e7eb]">{cases.cTitle}</Link>
                                    </h4>
                                </div>
                            </div>
                        ))}
