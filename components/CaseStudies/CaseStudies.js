            ...
            <div className="wraper">
                <div className="col-span-12 text-center">
                    <div className="mb-[60px]">
                        <span className="text-[16px] text-[#666666]">Örnek Çalışmalarımız</span>
                        <h2 className=" text-[36px] md:text-[26px] font-medium text-[#333] pb-[20px] relative before:absolute before:content-[''] before:left-[50%] before:bottom-0 before:transform before:-translate-x-1/2 before:w-[60px] before:h-[3px] before:bg-[#e5e7eb]">Son Emsal Kararlar</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div className="relative group">
                               ...
                               group-hover:opacity-100 group-hover:visible group-hover:bottom-0">
                                    <div className="absolute left-[5%] top-[5%] w-[90%] h-[90%] text-center border-[2px] border-[#e5e7eb] z-10 flex justify-center flex-col">
                                        <p className="text-[#e5e7eb] text-[16px] leading-[28px]">{cases.sub}</p>
