            ...
            <div className="wraper">
                <div className="grid grid-cols-12 gap-3">
                    <div className="col-span-5 md:col-span-12 ">
                        ...
                        before:w-[60px] before:h-[1px] before:bg-[#e5e7eb] md:before:hidden">Ücretsiz Danışmanlık</h2>
                            </div>
                            <span className="text-[18px] text-[#e5e7eb]">Bize 7/24 0530 799 35 43 veya 0533 595 84 54 numaralarından ulaşabilir veya formu doldurabilirsiniz.</span>
