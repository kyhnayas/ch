                ...
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-10 md:col-span-12">
                            ...
                            <div className="grid grid-cols-12 gap-3">
                                <div className="col-span-4 md:col-span-6 sm:col-span-12 md:mb-7">
                                    <div className="text-center p-[40px]  shadow-[0_5px_15px_0_rgba(62,65,159,0.1)]">
                                        <div className="w-[85px] h-[85px] bg-[#f5f5f5] leading-[85px] text-center mx-auto rounded-[50%]">
                                            <div className="icon">
                                                <i className="text-[35px] leading-[85px] text-[#ffffff] fa fa-map-marker" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                ...
                                <div className="col-span-4 md:col-span-6 sm:col-span-12 md:mb-7">
                                    <div className="text-center p-[40px]  shadow-[0_5px_15px_0_rgba(62,65,159,0.1)]">
                                        <div className="w-[85px] h-[85px] bg-[#f5f5f5] leading-[85px] text-center mx-auto rounded-[50%]">
                                            <div className="icon">
                                                <i className="text-[35px] leading-[85px] text-[#ffffff] fa fa-envelope" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                        <h2 className="text-[25px] text-[#ffffff] font-medium my-[20px]">E-Posta</h2>
                                        <p className="text-[#666] text-[16px] leading-[22px]">info@ch-hukuk.com</p>
                                    </div>
                                </div>
                                <div className="col-span-4 md:col-span-6 sm:col-span-12 md:mb-7">
                                    <div className="text-center p-[40px]  shadow-[0_5px_15px_0_rgba(62,65,159,0.1)]">
                                        <div className="w-[85px] h-[85px] bg-[#f5f5f5] leading-[85px] text-center mx-auto rounded-[50%]">
                                            <div className="icon">
                                                <i className="text-[35px] leading-[85px] text-[#ffffff] fa fa-phone" aria-hidden="true"></i>
                                            </div>
                                        </div>
                        ...
                        <div className="max-w-[440px] mx-auto text-center mb-[50px]">
                            <h2 className="text-[35px] col:text-[25px] text-[#ffffff] font-base-font font-bold mb-[20px]">Sorularınız mı Var?</h2>
                            <p className="text-[#666] text-[16px] leading-[22px]">Bizimle hemen iletişime geçerek hukuki konularda uzman avukatlarımızdan destek alabilirsiniz.</p>
                        </div>
