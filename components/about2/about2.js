                    ...
                    <div className="col-span-6 md:col-span-12">
                        <div className="mb-[20px]">
                            <div className="text-left sm:text-center">
                                <span className="text-[16px] text-[#666666]">Alanında Uzman</span>
                        ...
                        before:w-[60px] before:h-[1px] before:bg-[#e5e7eb] md:before:hidden">Neden Biz?</h2>
                            </div>
                            <p className="text-[#666] text-[15px] leading-[28px] mb-[30px]">Hukuki sorunlarınıza profesyonel ve etkili çözümler sunuyoruz. Uzun yıllara dayanan tecrübemiz ve güçlü kadromuzla yanınızdayız.</p>
                            <p className="text-[#666] text-[15px] leading-[28px] mb-[30px]">Müvekkillerimizin haklarını en üst düzeyde korumak için her aşamada şeffaf ve titizlikle çalışıyoruz.</p>
                            <div className="mb-[50px] col:mb-[20px]">
                                <Link href="/about" className="bg-[#e5e7eb] cursor-pointer text-[16px] font-semibold text-white px-[38px] py-[10px]  capitalize inline-block mt-[6px] transition ease-in-out duration-300 hover:bg-[#d4c291]
                        col:mb-[5px] col:mt-[15px] col:text-[15px] col:px-[18px] col:py-[8px] 
                        ">Hakkımızda Detaylı Bilgi</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-span-6 md:col-span-12">
                        <div className="relative mb-[20px]">
                            <div className="relative  max-w-[520px] ml-auto before:absolute before:bg-[#e5e7eb]
