    ...
    return (
        ...
        <section className="hero relative h-[790px] lg:h-[700px] col:h-[450px] overflow-hidden z-20">
            <div className="hero-slider">
                ...
                >
                    <SwiperSlide>
                        <div className="slide-inner slide-bg-image h-[790px] lg:h-[700px] col:h-[450px] bg-[#0f1115]" style={{ backgroundImage: `url(${'/images/slider/slide-1.jpg'})` }}>
            ...
            after:w-full after:h-full after:left-0 after:top-0 after:opacity-70 after:z-10">
                    ...
                    <SwiperSlide>
                        <div className="slide-inner slide-bg-image h-[790px] lg:h-[700px] col:h-[450px] bg-[#0f1115]" style={{ backgroundImage: `url(${'/images/slider/slide-2.jpg'})` }}>
                            <div className="slide  relative h-full bg-cover lg:bg-[length:100%_auto] bg-top bg-no-repeat z-10  after:absolute after:content-[''] 
            after:w-full after:h-full after:left-0 after:top-0 after:opacity-70 after:z-10">
                                <div className="wraper">
                                    <div className="slide-caption w-[700px] mt-[285px]  md:mt-[120px] col:mt-[100px] absolute top-0 z-20">
