...
const Testimonial = (props) => {
    ...
    const testimonial = [
        {
            tsImg: ts1,
            Des: "CH Hukuk Bürosu ile çalıştıktan sonra hukuki süreçlerimizin ne kadar şeffaf ve profesyonel yürütüldüğünü gördük. Kesinlikle tavsiye ediyoruz.",
            Title: 'Melih Kaya',
            Sub: "Müvekkil",
        },
        {
            tsImg: ts2,
            Des: "Dava sürecimizde başından sonuna kadar bizi her konuda bilgilendirdiler. Emekleri ve uzmanlıkları için çok teşekkür ederiz.",
            Title: 'Ayşe Demir',
            Sub: "Müvekkil",
        }
    ]
                    ...
                    <div className="col-span-8 md:col-span-6 sm:col-span-12 sm:order-1">
                        <div className="testimonial-text ml-[95px] mt-[50px] md:ml-0">
                            <div className="text-left sm:text-center">
                                <span className="text-[16px] text-[#666666]">Hakkımızda Neler Söylediler?</span>
                        ...
                        before:w-[60px] before:h-[1px] before:bg-[#e5e7eb] md:before:hidden">Müvekkil Yorumları</h2>
                            </div>
                            <div className="testimonial-slide owl-carousel">
                                <Slider {...settings}>
                                    {testimonial.map((tesmnl, tsm) => (
                                        <div className="slide-item sm:text-center" key={tsm}>
                                            <p className="relative pt-[30px] sm:p-0 z-10 sm:pl-[20px] pl-[33px] pb-[30px] pr-[50px] mb-[20px] before:absolute before:left-[4px] before:top-[5px] before:content-['\f10d'] before:-z-10  before:font-['FontAwesome'] before:text-[#e5e7eb] before:text-[30px] sm:before:text-[20px]">{tesmnl.Des}</p>
