            ...
            <div className="wraper">
                <div className="col-span-12 text-center">
                    <div className="mb-[60px]">
                        <span className="text-[16px] text-[#666666]">Our Pricing Plan</span>
               ...
               before:left-[50%] before:bottom-0 before:transform before:-translate-x-1/2 before:w-[60px] before:h-[3px]
                before:bg-[#e5e7eb]">Pricing Table</h2>
                    </div>
                </div>
                <div className="grid grid-cols-12 gap-3">
                    ...
                    group-hover:text-white">
                                ...
                                <Link href="/practice" className="transition-all ease-in-out group-hover:text-[#e5e7eb] group-hover:bg-white bg-[#e5e7eb] text-[16px] font-semibold text-white py-[10px] px-[38px] capitalize inline-block">Get Started</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-span-4 md:col-span-6 sm:col-span-12 mb-5">
